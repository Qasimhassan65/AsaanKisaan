...
dependencies {
    ...
    // TensorFlow Lite for Android (UPDATED VERSIONS)
    implementation("org.tensorflow:tensorflow-lite-task-vision:0.6.0")
    implementation("org.tensorflow:tensorflow-lite-gpu:2.16.0")
    implementation("org.tensorflow:tensorflow-lite-support:0.4.4") // Explicitly added
